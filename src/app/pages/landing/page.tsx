            ...
            <UILibrary.Navbar
                logo={
                    <div className="font-bold text-2xl tracking-tight text-indigo-600 flex items-center gap-2">
                        ...
                        <span>
                            Ryze<span className="text-slate-900 font-extrabold">Agent</span>
                        </span>
                    </div>
                }
                actions={
                    <div className="flex items-center gap-4">
                        ...
                        <UILibrary.Button
                            variant="primary"
                            className="rounded-full px-6 shadow-md shadow-indigo-200"
            ...
            <main className="max-w-7xl mx-auto px-6 pt-20 pb-32">
                ...
                <div className="flex flex-col items-center text-center space-y-8 mb-32">
                    ...
                    <h1 className="text-7xl font-extrabold tracking-tight text-slate-900 max-w-4xl leading-[1.1]">
                        Build Production interfaces with{" "}
                    ...
                    <p className="text-xl text-slate-500 max-w-2xl leading-relaxed">
                        RyzeAgent combines the power of LLMs with a rigid, high-performance
                        component library to help you ship feature-complete UIs in seconds.
                    </p>

                    <div className="flex items-center gap-6 pt-4">
                        <UILibrary.Button
                            variant="primary"
                            className="px-10 py-7 text-lg rounded-2xl shadow-xl shadow-indigo-100 flex items-center gap-2 hover:scale-[1.02] transition-transform"
                            onClick={() => router.push("/pages/agent")}
                        >
                        ...
                        <UILibrary.Button
                            variant="outline"
                            className="px-10 py-7 text-lg rounded-2xl bg-white flex items-center gap-2 hover:bg-slate-50 transition-colors"
                        >
                            Explore Library
                        </UILibrary.Button>
                    </div>
                ...
                <UILibrary.Card className="border-none shadow-2xl rounded-3xl overflow-hidden bg-white min-h-0">
                    <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[420px]">
                        <div className="p-16 space-y-8 bg-linear-to-br from-indigo-900 to-slate-900 text-white flex flex-col justify-center min-w-0 min-h-[380px] lg:min-h-0">
                            <h2 className="text-4xl font-bold leading-tight">
                                Ready to ship your next idea?
                            </h2>
                            <p className="text-indigo-100 text-lg leading-relaxed">
                                Join the thousands of developers who have swapped manual coding
                                for agentic design. Describe it, and we'll build it.
                            </p>
                            <div className="space-y-4 max-w-md">
                                ...
                                <UILibrary.Button
                                    variant="primary"
                                    className="w-full h-14 text-lg bg-indigo-500 hover:bg-indigo-400 border-none shadow-lg"
                                >
                                    Submit Waitlist
                                </UILibrary.Button>
                            </div>
                        </div>
                        {/* <div className="p-16 flex flex-col justify-center bg-slate-50/50 min-w-0">
                            <div className="w-full space-y-6 min-w-0">
                                <div className="flex items-center justify-between gap-2">
                                    <h3 className="font-bold text-slate-900 text-lg">Platform Growth</h3>
                ...
                <footer className="mt-40 text-center border-t border-slate-200 pt-16">
                    <p className="text-slate-400 text-sm">
                        © 2026 RyzeAgent Intelligence Inc. All rights reserved.
                    </p>
                </footer>
            </main>
        </div>
        ...
        <UILibrary.CardContent className="p-10 space-y-6">
            <div
                className={
                    "w-14 h-14 " +
                    color +
                    " rounded-2xl flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform duration-300"
                }
            >
                {icon}
            </div>
